        ...
        <table id="nilai_mahasiswa" class="table table-bordered table-striped table-sm">
            <thead>
                <tr>
                    ...
                    <th style="width: 125px;">Nama Industri</th>
            ...
            <div class="modal-body">
                <div class="container">
                    ...
                    <div class="form-group-sm mb-3">
                        <label for="modal-nilai-data-motivasi" class="form-label">Motivasi:</label>
                        <input type="number" class="form-control" id="modal-nilai-data-motivasi">
                    </div>
                    <div class="form-group-sm mb-3">
                    ...
                    <div class="form-group-sm mb-3">
                        <label for="modal-nilai-data-metode" class="form-label">Metode Pembahasan Laporan:</label>
                        <input type="number" class="form-control" id="modal-nilai-data-metode">
                    </div>
                </div>
            </div>
...
<script>
        ...
        $.ajax({
            ...
            success: function(res) {
                if (res.success) {
                    ...
                    $('#modal-nilai').find('#modal-nilai-data-motivasi').val(res.data.motivasi);
                    ...
                    $('#modal-nilai').find('#modal-nilai-data-metode').val(res.data.metode);
    ...
    function simpanNilai() {
        ...
        var motivasi = $('#modal-nilai').find('#modal-nilai-data-motivasi').val();
        ...
        var metode = $('#modal-nilai').find('#modal-nilai-data-metode').val();

        $.ajax({
            url: '/api/nilai-bimbingan/' + id + '/edit',
            type: 'POST',
            dataType: 'json',
            data: {
                id: id,
